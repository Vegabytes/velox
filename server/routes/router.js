...
import { getLogsByDeviceId, getLogDetail,getDenuncias,getDenunciaDetail } from '../controllers/logsController.js'
...
router.get('/denuncias/:idGroup', getDenuncias)
router.get('/denuncia/:idLog',getDenunciaDetail)
