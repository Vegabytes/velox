...
import { getLogsByDeviceId, getLogDetail, getInfracciones, getDenunciaDetail } from '../controllers/logsController.js'
...
router.get('/infraccion/:idLog', getDenunciaDetail)
