<template>
  <v-row>
    ...
    <v-col md="11" cols="12" class="d-flex justify-center align-center py-0">

      <v-img :src="`${path}/${props.path}`" class="align-end rounded-bs-xl" gradient="to bottom, rgba(0,0,0,.1), rgba(0,0,0,.5)"
        height="150px" cover>
